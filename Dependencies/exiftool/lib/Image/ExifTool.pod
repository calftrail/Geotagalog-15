...
Or the ExifTool C<configFile> variable may be set before loading
Image::ExifTool to use a specific configuration file:
...
trailer.  With RIFF-format files (AVI, WAV, etc), this option stops the
parsing at the audio/video data, so any trailing metadata (ie. XMP written
by Adobe Bridge) may be missed.  Also, when combined with the ScanForXMP
option, prevents scanning for XMP in recognized file types.  Default is 0.
...
HtmlDumpBase, IgnoreMinorErrors, IPTCCharset, Lang, LargeFileSupport,
MakerNotes, ScanForXMP, Struct, TextOut, Unknown and Verbose.
...
ByteOrder, Charset, Compact, Compress, FixBase, IgnoreMinorErrors,
IPTCCharset and Verbose.
...
AFCP, AIFF, APE, APP0, APP12, APP13, APP14, APP15, APP5, APP6, APP8, ASF,
BMP, CanonVRD, Composite, DICOM, DNG, DjVu, Ducky, EXE, EXIF, ExifTool,
FLAC, File, Flash, FlashPix, FotoStation, GeoTiff, HTML, ICC_Profile, ID3,
IPTC, ITC, JFIF, JPEG, Jpeg2000, LNK, Leaf, M2TS, MIE, MIFF, MNG, MPC, MPEG,
MPF, MakerNotes, Meta, PDF, PICT, PNG, PhotoMechanic, Photoshop, PostScript,
PrintIM, QuickTime, RAF, RIFF, Rawzor, Real, SVG, SigmaRaw, Stim, Vorbis,
XML, XMP, ZIP
...
EPPIM, EXE, EXIF, ExifIFD, ExifTool, FLAC, File, Flash, FlashPix,
FotoStation, FujiFilm, GPS, GeoTiff, GlobParamIFD, GraphConv, H264, HP,
...
Minolta, MinoltaRaw, NITF, Nikon, NikonCapture, NikonPreview, NikonScan,
...
Sanyo, Sigma, SigmaRaw, Sony, Stim, SubIFD, System, Track#, Vorbis, XML,
XMP, XMP-DICOM, XMP-MP, XMP-PixelLive, XMP-acdsee, XMP-album, XMP-aux,
XMP-cc, XMP-crs, XMP-dc, XMP-dex, XMP-exif, XMP-iptcCore, XMP-iptcExt,
XMP-lr, XMP-mediapro, XMP-microsoft, XMP-pdf, XMP-pdfx, XMP-photomech,
