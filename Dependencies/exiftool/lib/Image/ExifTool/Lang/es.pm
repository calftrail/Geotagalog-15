...
%Image::ExifTool::Lang::es::Translate = (
   ...
   'Compression' => {
      ...
      PrintConv => {
        'Epson ERF Compressed' => 'Compresión Epson ERF',
   ...
   'LightSource' => {
      ...
      PrintConv => {
        ...
        'Cool White Fluorescent' => 'Fluorescente blanco cálido (W 3900 - 4500K)',
        'Day White Fluorescent' => 'Fluorescente blanco día (N 4600 - 5400K)',
