...
CameraInfo tags for the EOS 7D.
   ...
   -----   --------                             --------
     ...
     25    CameraTemperature                    int8u
     30    FocalLength                          int16u
     32    CameraInfo7D_2a                      Canon CameraInfo7D_2
     36    CameraInfo7D_2b                      Canon CameraInfo7D_2

=head3 Canon CameraInfo7D_2 Tags

More CameraInfo tags for the EOS 7D.

   Index   Tag Name                             Writable
   -----   --------                             --------
     17    CameraOrientation                    int8u
     48    FocusDistanceUpper                   int16u
     50    FocusDistanceLower                   int16u
     83    WhiteBalance                         int16u
     87    ColorTemperature                     int16u
    165    HighISONoiseReduction                int8u
    239    LensType                             int8u
    240    ShortFocal                           int16u
    242    LongFocal                            int16u
    392    FirmwareVersion                      N
    455    FileIndex                            int32u
    467    DirectoryIndex                       int32u
...
Camera settings information for the Sony DSLR-A100.
   ...
   -----   --------                             --------
      ...
      6    ManualExposureTime                   int16u
      7    ManualFNumber                        int16u
      8    ExposureTime                         int16u
      9    FNumber                              int16u
     10    DriveMode2                           int16u
     11    WhiteBalance                         int16u
     12    FocusMode                            int16u
     13    LocalAFAreaPoint                     int16u
     14    AFAreaMode                           int16u
     15    FlashMode                            int16u
     16    FlashExposureCompSetting             int16u
     18    MeteringMode                         int16u
     19    ISOSetting                           int16u
     20    ZoneMatching                         int16u
...
=head2 Nikon Tags
  ...
  0x00bd   PictureControl                       Nikon PictureControl
  0x0e00   PrintIM                              PrintIM
...
=head3 Nikon CameraSettingsD300 Tags
...
D200.
   ...
   -----   --------                             --------
    ...
    9.2    FlashControlMode                     [Mask 0x7f]
                                                Nikon FlashControlMode
     ...
     15    FlashGroupAControlMode               [Mask 0xf]
                                                Nikon FlashControlMode
     16    FlashGroupBControlMode               [Mask 0xf]
                                                Nikon FlashControlMode
...
These tags are used by the D40, D40X, D60, D3 and D300.
   ...
   16.1    FlashGroupAControlMode               [Mask 0xf]
                                                Nikon FlashControlMode
   17.1    FlashGroupBControlMode               [Mask 0xf0]
                                                Nikon FlashControlMode
   17.2    FlashGroupCControlMode               [Mask 0xf]
                                                Nikon FlashControlMode
...
These tags are used by the D90 and D700.
   ...
   -----   --------                             --------
    ...
    9.2    FlashControlMode                     [Mask 0x7f]
     ...
     14    RepeatingFlashCount                  int8u
     15    FlashGNDistance                      int8u
   17.1    FlashGroupAControlMode               [Mask 0xf]
                                                Nikon FlashControlMode
   18.1    FlashGroupBControlMode               [Mask 0xf0]
                                                Nikon FlashControlMode
   18.2    FlashGroupCControlMode               [Mask 0xf]
                                                Nikon FlashControlMode
...
=head3 Panasonic FaceDetInfo Tags
...
=head3 Panasonic FaceRecInfo Tags
...
=head3 M2TS H264 Tags

Tags extracted from H.264 video streams.
...
=head3 QuickTime GenMediaHeader Tags
...
=head3 QuickTime GenMediaInfo Tags
...
=head3 QuickTime UserMedia Tags

  Tag ID   Tag Name                             Writable
  ------   --------                             --------
  'MTDT'   MetaData                             QuickTime MetaData

=head3 QuickTime MetaData Tags
...
=head3 QuickTime AudioProf Tags
...
=head3 QuickTime VideoProf Tags
...
These tags are part of the EXIF 2.2 specification for WAV audio files.
...
Information extracted from MS Shell Link (Windows shortcut) files.
   ...
   -----       --------                         --------
         ...
         60    RunWindow                        N
         64    HotKey                           N
  0x00010000   ItemID                           LNK ItemID
  0x00020000   LinkInfo                         LNK LinkInfo
  0x00030004   Description                      N
  0x00030008   RelativePath                     N
  0x00030010   WorkingDirectory                 N
  0x00030020   CommandLineArguments             N
  0x00030040   IconFileName                     N
...
=head3 LNK ItemID Tags

  Tag ID   Tag Name                             Writable
  ------   --------                             --------
  0x0032   Item0032                             LNK Item0032

=head3 LNK Item0032 Tags

   Index   Tag Name                             Writable
   -----   --------                             --------
     14    TargetFileDOSName                    N

=head3 LNK LinkInfo Tags
...
=head3 LNK TrackerData Tags

   Index   Tag Name                             Writable
   -----   --------                             --------
     16    MachineID                            N

=head3 LNK ConsoleFEData Tags
